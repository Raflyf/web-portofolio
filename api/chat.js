 ...
 * Supports: OpenRouter (DeepSeek/Llama), Nvidia NIM, MiniMax, Opencode
 * Secure Server-Side Key Management + Visitor Custom Key / Model Passthrough
 * ============================================================================
 */
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // ========================================================================
    // CASCADE LAYER 2: Nvidia NIM (Llama 3.3 / DeepSeek)
    // ========================================================================
    if (NVIDIA_KEY) {
      try {
