...
| **1.3.0** | 2026-08-16 | Integrasi pengiriman formulir riil ke Gmail (`raflyfirmansyah02@gmail.com`) via FormSubmit AJAX, tombol Salin Email 1-klik dengan notifikasi Toast mengambang, penampil pratinjau PDF tersemat langsung di dalam modal dialog sertifikat, opsi Dual-Delivery ke WhatsApp Web, dan banner OpenGraph resolusi tinggi. |
