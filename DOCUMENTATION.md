...
| **3.4.0** | 2026-08-17 | Integrasi AI Assistant interaktif pada Terminal Developer Lab (`js/terminal-ai.js`): Arsitektur Multi-API Cascade (DeepSeek/OpenRouter, Groq Llama, Gemini Flash, Ollama Local) dengan failover otomatis ke In-Browser Local Semantic Knowledge Engine (<15ms, 100% offline & zero-cost). Pengunjung dapat bertanya bebas dalam bahasa alami mengenai profil, riset skripsi, proyek, atau sertifikasi BNSP/MikroTik tanpa terbatas keyword kaku. |
