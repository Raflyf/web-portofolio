...
export const PROJECTS_DATA_I18N = {
  id: [
    ...
    },
    {
      ...
      category: "ai-ml",
      categoryLabel: "AI Agent & Multimodal",
      badge: "WhatsApp & Telegram Agent",
      description: "Asisten AI multimodal cerdas 24/7 di WhatsApp dan Telegram dengan transkripsi suara Whisper, pemrosesan dokumen PDF/Word, dan rantai failover otomatis 4 provider LLM.",
      longDescription: "FreeAiBot adalah agen kecerdasan buatan multimodal mandiri yang dirancang untuk beroperasi 24/7 pada platform pesan instan WhatsApp (via Baileys) dan Telegram Bot API dengan backend Vercel Serverless dan Supabase PostgreSQL. Dilengkapi pengelolaan memori percakapan kontekstual dengan koreksi /salah, pipeline ekspor dataset prompt-completion (JSONL/CSV) untuk fine-tuning LLM, transkripsi suara OpenAI Whisper (~500ms), serta rotasi failover multi-provider (xKiro Gateway, Groq, Google Gemini, OpenRouter).",
      keyFeatures: [
        "Pipeline ekspor dataset prompt-completion (JSONL/CSV) untuk fine-tuning LLM",
      ...
      techStack: ["TypeScript", "Vercel Serverless", "Supabase PostgreSQL", "WhatsApp Baileys", "Telegram API", "Whisper AI"],
  ...
  en: [
    ...
    },
    {
      ...
      categoryLabel: "AI Agent & Multimodal",
      badge: "WhatsApp & Telegram Agent",
      description: "Intelligent 24/7 multimodal AI assistant operating on WhatsApp and Telegram featuring Whisper voice transcription, PDF/Word document processing, and a 4-tier LLM provider failover cascade.",
      longDescription: "FreeAiBot is a self-hosted multimodal conversational AI agent engineered for 24/7 reliability across WhatsApp (via Baileys) and Telegram Bot API, powered by Vercel Serverless and Supabase PostgreSQL. Features include contextual conversational memory with interactive /salah correction commands, prompt-completion dataset export pipelines (JSONL/CSV) for LLM fine-tuning, ultra-fast Whisper voice transcription (~500ms), and resilient multi-provider failover routing (xKiro Gateway, Groq, Google Gemini, OpenRouter).",
      keyFeatures: [
        "Prompt-completion dataset export pipeline (JSONL/CSV) for LLM fine-tuning",
