...
export default function ExperienceTimeline() {
  ...
  return (
    <section id="experience" ref={containerRef} className="relative px-4 sm:px-6 w-full max-w-4xl mx-auto pt-24 pb-24">
      <motion.div 
          ...
          {TIMELINE_DATA.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Timeline Dot */}
                <div className="absolute left-0 sm:left-1/2 w-8 h-8 rounded-full border border-white/20 bg-black/90 backdrop-blur-xl flex items-center justify-center transform -translate-x-1/2 sm:-translate-x-1/2 z-10 shadow-[0_0_15px_rgba(0,0,0,0.8)] group-hover:scale-125 transition-all duration-300">
                ...
                <div className={`w-full sm:w-[45%] pl-8 sm:pl-0 ${isLeft ? 'sm:pr-12 sm:text-right' : 'sm:pl-12 sm:text-left'}`}>
                  <motion.div 
                    ...
                    className="rounded-2xl border border-white/10 bg-black/40 p-6 sm:p-7 backdrop-blur-2xl shadow-xl hover:border-white/20 transition-colors relative overflow-hidden text-left"
                  >
