        ...
        <Reveal x={30} duration={0.6} amount={0.2} className="lg:col-span-7 p-8 sm:p-10 liquid-glass-strong relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            ...
            <button
              ...
              className="w-full py-4 px-6 rounded-full font-bold text-sm stitch-btn-primary flex items-center justify-center gap-2 cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (
                <>
