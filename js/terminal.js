...
export function initTerminal() {
  ...
  const COMMAND_REGISTRY = {
    ...
    models: () => [
      ...
      "----------------------------------------------------------------",
      "1. OmniRoute Dedicated Local Gateway (Port 20128):",
      "   - Codex (GPT-5.6 Terra - Feb 2026 | Coding Specialist)",
      "   - Antigravity (Claude Opus 4.6 Thinking - Feb 2026 | Deep CoT)",
      "   - nemotron-laguna (Nemotron 3.5 Laguna - Jan 2026 | Ultra Fast)",
      "   - Vision-model (Gemini 3.1 Flash Vision - Feb 2026 | Image & OCR)",
      "   - Deepseek-V4-Flash-Free (DeepSeek V4 Flash - Mar 2026 | Fast Inference)",
      "",
      "2. OpenCode Zen Cloud Multi-Account Pool (opencode.ai):",
      "   - opencode/nemotron-3-ultra-free (Nemotron 3 Ultra 550B - Jan 2026)",
      "   - opencode/laguna-s-2.1-free (Laguna S 2.1 - Jan 2026)",
      "   - opencode/mimo-v2.5-free (Mimo v2.5 - Feb 2026)",
      "   - opencode/x-preview-f-free (X-Preview Frontier - Feb 2026)",
      "   - opencode/muse-spark-1.2-contributor-free (Muse Spark 1.2 - Jan 2026)",
      "   - opencode/hy3-free (HY3 Assistant - Jan 2026)",
      "   - opencode/big-pickle (Big Pickle - Des 2025)",
      "",
      "3. OpenRouter Modern SOTA Pool (openrouter.ai):",
      "   - nvidia/nemotron-3-ultra-550b-a55b:free (550B MoE - Des 2025)",
      "   - nvidia/nemotron-3-super-120b-a12b:free (120B CoT - Des 2025)",
      "",
      "4. Ollama Cloud Hub (ollama.com):",
      "   - nemotron-3-ultra (550B MoE - Des 2025)",
      "   - minimax-m3 (Frontier Multimodal - Feb 2026)",
      "",
      "5. In-Browser Local Engine (Zero-Latency Offline):",
      "   - Local Semantic Engine (Sub-15ms Exact & Semantic Matcher)",
      "",
      "Perintah Penggantian: Ketik 'model <nama>' (contoh: model codex / model antigravity / model auto)."
    ],
    telemetry: () => {
