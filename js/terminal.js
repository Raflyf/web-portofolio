...
export function initTerminal() {
  ...
  const COMMAND_REGISTRY = {
    ...
    models: () => [
      ...
      "   - nemotron-3.5-lightning (1M Context | High-Speed Lightning)",
      "   - nemotron-3-ultra (550B MoE | Deep Analytical Research)",
      "   - minimax-m3 (Frontier Multimodal Vision | Document & Image)",
      "",
      ...
      "",
      "4. OpenCode Zen Cloud Multi-Account Pool & MiniMax API (Tier 4):",
      "   - opencode/nemotron-3-ultra-free (Nemotron 3 Ultra 550B)",
      "   - opencode/laguna-s-2.1-free (Laguna S 2.1)",
      "   - opencode/mimo-v2.5-free (Mimo v2.5 Multimodal)",
      "   - opencode/x-preview-f-free (X-Preview Frontier)",
      "   - MiniMax-M3 (Multimodal Vision Direct Production API)",
      "",
      "5. In-Browser Local Engine (Zero-Latency Offline | Tier 5):",
      "   - Local Semantic Engine + Supabase Continuous RAG Memory",
      "",
      "Perintah Penggantian: Ketik 'model <nama>' (contoh: model codex / model antigravity / model nano / model auto)."
    ],
    telemetry: () => {
