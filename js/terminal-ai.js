...
- Dilarang monolog internal bahasa Inggris. Nol emoji.`;
    ...
    let targetEffort = explicitEffort || (hasImages ? 'HIGH' : (isCasualOrShort || isFileExportQuery ? 'LOW' : (isPlanningOrSystemDesign || isDeepReasoning ? 'THINKING' : (isProjectExplaining || isHeavyCoding ? 'HIGH' : 'MEDIUM'))));
