...
import { DEVELOPER_PROFILE, PROJECTS_DATA, CERTIFICATES_DATA, TIMELINE_DATA } from './data.js?v=10.74.0';
import { initTerminal } from './terminal.js?v=10.74.0';
import { telemetry } from './telemetry.js?v=10.74.0';
