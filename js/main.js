...
import { DEVELOPER_PROFILE, PROJECTS_DATA, CERTIFICATES_DATA, TIMELINE_DATA } from './data.js?v=10.100.0';
import { initTerminal } from './terminal.js?v=10.100.0';
...
function refreshScrollReveal() {
  ...
  const revealElements = document.querySelectorAll(
    '.hero-pill-badge, .hero-main-title, .hero-lead-text, .hero-btn-group, .section-header, .about-bio, .pillar-card, .marquee-container, .skills-bento-grid, .bento-tile, .filter-bar, .project-spotlight-card, .project-card, .certificate-card, .timeline-item, .terminal-card, #terminal-inpage-slot, .contact-method-card, .contact-form, .site-footer, .stats-strip, .hero-showcase-canvas'
  );
